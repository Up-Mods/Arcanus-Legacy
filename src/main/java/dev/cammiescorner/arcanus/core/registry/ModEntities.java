...
public class ModEntities
{
	...
	//-----Entities-----//
	public static final EntityType<SolarStrikeEntity> SOLAR_STRIKE = create("solar_strike", FabricEntityTypeBuilder
			.<SolarStrikeEntity>create(SpawnGroup.MISC, (type, world) -> new SolarStrikeEntity(world))
