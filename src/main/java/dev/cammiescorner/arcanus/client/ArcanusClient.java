...
public class ArcanusClient implements ClientModInitializer {
	...
	private static final Item[] HOOD_ITEMS = new Item[] {
	...
	public void onInitializeClient(ModContainer mod) {
		...
		ArmorRenderer.register(new TimeCultRobesRenderer(), ArcanusItems.TIME_CULTIST_HOOD, ArcanusItems.TIME_CULTIST_ROBE, ArcanusItems.TIME_CULTIST_LEGGINGS, ArcanusItems.TIME_CULTIST_BOOTS);
